...
namespace MyOfficeSpace.Clients
{
    public partial class EditClient : Form
    {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = conn;
            cmd.CommandText = "update Clients set Client_Name = '" + ClientNametxt.Text + "',Phone = '" + ClientTeltxt.Text + "',Email = '" + ClientEmailtxt.Text + "' where Client_Name = '" + s + "'";
